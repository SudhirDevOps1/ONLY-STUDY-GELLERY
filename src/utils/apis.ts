...
export const getNumberFact = (num: number | string = 'random') => apiCall<string>(`http://numbersapi.com/${num}?json`);
...
// ============ EDUCATION ============
export const getUniversities = (country = 'india') => apiCall<any>(`http://universities.hipolabs.com/search?country=${country}`);
...
export const getDuckImage = () => apiCall<any>('https://random-d.uk/api/v2/random');
